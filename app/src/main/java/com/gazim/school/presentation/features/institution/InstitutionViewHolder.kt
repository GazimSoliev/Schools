    ...
    fun bindItem(institution: Institution) {
        with(binding) {
            ...
            if (institution.favorite) {
                ...
                buttonFavorite.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_baseline_star_24, 0, 0, 0)
            }
            else {
                buttonFavorite.setText(R.string.buttonFavoriteAddText)
                buttonFavorite.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_baseline_star_border_24, 0, 0, 0)
            }
